...
public class AutokeyCipherTest {
    ...
    public void lowercaseTextLowercaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "pizza");
    ...
    public void lowercaseTextMixcaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "Yummy");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseTextLowercaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "steaks");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseTextMixcaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "salad");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedTextLowercaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "bags");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedTextMixcaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "Amoeba");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedTextLowercaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "glorytothesnow");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedTextMixcaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "CrossYourMind");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedMixCharTextLowercaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "bowl");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedMixCharTextMixcaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "Ballad");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedMixCharTextLowercaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "concert");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedMixCharTextMixcaseShorterKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "Illinois");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseTextLowercaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "greetings");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseTextMixcaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "FORTISSIMO");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseTextLowercaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "penguin");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseTextMixcaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "SourDough");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedTextLowercaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "imonthetv");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedTextMixcaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "ofAlexandria");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedTextLowercaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "lavieillegarde");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedTextMixcaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "TheUniversityOfNebraskaLincoln");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedMixCharTextLowercaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "butilikepancakestoo");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedMixCharTextMixcaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "AndHisBrotherLuigi");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedMixCharTextLowercaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "reddeadredemptiontwo");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedMixCharTextMixcaseLongerKey() {
        ...
        String[] actualOutput = StringEncryptor.autokeyCipher(plaintext, "INeedToUpgrade");
        assertArrayEquals(expectedOutput, actualOutput);
    }
}
