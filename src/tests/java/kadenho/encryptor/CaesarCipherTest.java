...
class CaesarCipherTest {
    ...
    public void lowercaseLettersShiftOne() {
        ...
        String[] actualOutput = StringEncryptor.caesarCipher(plaintext, 1);
    ...
    public void lowercaseLettersShiftTen() {
        ...
        String[] actualOutput = StringEncryptor.caesarCipher(plaintext, 10);
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseLettersShiftTwentyFive() {
        ...
        String[] actualOutput = StringEncryptor.caesarCipher(plaintext, 25);
        assertArrayEquals(expectedOutput, actualOutput);
    }
