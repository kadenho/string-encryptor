...
public class EncryptMixedAlphabetCipherTest {
    ...
    public void lowercaseTextLowercaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "goodbyeworld");
    ...
    public void lowercaseTextMixcaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "ComputerScience");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseTextLowercaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "waffles");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseTextMixcaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "iLikeSnakeCase");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedTextLowercaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "clairo");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedTextMixcaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "Beabadoobee");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedTextLowercaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "themarias");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedTextMixcaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "IndiePop");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedMixCharTextLowercaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "studiocanal");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseSpacedMixCharTextMixcaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "Marmalade");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedMixCharTextLowercaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "scream");
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void mixcaseSpacedMixCharTextMixcaseKey() {
        ...
        String[] actualOutput = StringEncryptor.encryptMixedAlphabetCipher(plaintext, "NaBoRa");
        assertArrayEquals(expectedOutput, actualOutput);
    }
