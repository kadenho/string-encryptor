...
class EncryptCaesarCipherTest {
    ...
    public void lowercaseLettersShiftOne() {
        ...
        String[] actualOutput = StringEncryptor.encryptCaesarCipher(plaintext, 1);
    ...
    public void lowercaseLettersShiftTen() {
        ...
        String[] actualOutput = StringEncryptor.encryptCaesarCipher(plaintext, 10);
        assertArrayEquals(expectedOutput, actualOutput);
    }
    ...
    public void lowercaseLettersShiftTwentyFive() {
        ...
        String[] actualOutput = StringEncryptor.encryptCaesarCipher(plaintext, 25);
        assertArrayEquals(expectedOutput, actualOutput);
    }
